...
OUTPUT_FILENAME = os.getenv("OUTPUT_FILENAME", "system_recorded.wav")
...
LOCAL_MODELS_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "Local_Models")
